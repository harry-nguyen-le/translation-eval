...
import { validateUrlPreservation } from "../src/url-preservation/index";
import type { UrlPreservationIssue } from "../src/url-preservation/index";
...
function evaluateTranslations(translations: MasterTranslations) {
  ...
  for (const [id, entry] of Object.entries(translations)) {
    ...
    for (const field of TARGET_FIELDS) {
      ...
      const validation = validateUrlPreservation(source, target);
