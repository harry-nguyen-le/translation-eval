...
- stylistic inline tags such as `strong`, `em`, `span`, and `b` may move or disappear
- functional inline elements such as links, buttons, inputs, and media must preserve their tag and attributes
